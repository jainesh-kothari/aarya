...
class _UpdateChildrenState extends State<UpdateChildren> {
  ...
  final List<String> _cast_category = ['Brahman','Baniya','Rajput','Other'];
  ...
  _getDetails() async {
    ...
    setState(() async {
      ...
      _category_list = ApiService().getCastCategory();
      ...
      dob_controller.text = _childData!.data!.dOB.toString();
      ...
      _chosenCategoryName = _childData!.data!.categoryId.toString();
                 ...
                 /* Center(
                  ...
                  Visibility(
                    ...
                    child: Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        hint:Text(_chosenCaste == null ? AppTranslations.of(context)!.text("select_cast") : _chosenCaste!,
                          style: const TextStyle(
                              color: Colors.black,
                              fontSize: 14,
                              fontWeight: FontWeight.w500),
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      } else if (_chosenCategory.toString().isEmpty) {

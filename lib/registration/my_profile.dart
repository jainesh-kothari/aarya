...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  UserProfileGS user_profile = UserProfileGS();
  ...
  _getDetails() async {
    ...
    user_profile = (await ApiService().getUserProfile())!;
    ...
    setState(() {
      visible = false;
      name_controller.text = "${user_profile!.firstName} ${user_profile!.middleName} ${user_profile!.lastName} ";

      mobile_number = "${user_profile!.mobile}";
      state = "${user_profile!.userAccess!.state!.name}";
      district = "${user_profile!.userAccess!.district!.name}";
      area = "${user_profile!.userAccess!.area!.name}";
      block = "${user_profile!.userAccess!.block!.name}";
      gramPanchayat = "${user_profile!.userAccess!.gramPanchayat!.name}";
      center = "${user_profile!.userAccess!.center!.name}";

      if (user_profile!.email != null)
        email_controller.text = "${user_profile!.email}";
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(is_gnm == true ? "YES" : "NO",style: style1)
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(is_arya == true ? "YES" : "NO",style: style1)
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(is_sathin == true ? "YES" : "NO",style: style1)
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text("$mobile_number",style: style1)
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text("$gramPanchayat",style: style1)
                            ...
                            child: MaterialButton(
                              ...
                              onPressed: () async{
                                ...
                                if (name_controller.text.isEmpty) {
                                  ...
                                  Fluttertoast.showToast(msg: "Please enter the aadhar number");
                                  ...
                                  String? response = await ApiService().updateUserProfile(name_controller.text.toString(),
                                      mobile_number, email_controller.text,aadhar_controller.text);

...
class PinCodeTextFieldOlder extends StatefulWidget {
...
class _PinCodeTextFieldState extends State<PinCodeTextFieldOlder> {
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
              shape: widget.shape == PinCodeFieldShape.circle
                  ...
                  : BoxShape.rectangle,
              borderRadius: borderRadius,
              color: _selectedIndex <= i ?  Color(AppConstants.GRAY_COLOR[4]) : Color(AppConstants.BLUE_COLOR[0]),
              border: widget.shape == PinCodeFieldShape.underline
                  ...
                  : Border.all(
                color: _selectedIndex <= i ? widget.activeColor : widget.inactiveColor,
                width: widget.borderWidth,
              )),
          child: Center(
